...
Turn the project brief for `Kickstart` into the first verified implementation slice.
...
- Review existing docs and source files before proposing changes.
- Identify the repeatable validation command.
